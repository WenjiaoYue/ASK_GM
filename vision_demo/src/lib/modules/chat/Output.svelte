...
{#if output}
	<div class="flex flex-col">
		<span
			class="mb-2 flex h-[3rem] items-center justify-center bg-[#5856D6] px-8 py-2 text-center text-[0.89rem] uppercase leading-tight opacity-80"
			>{label}</span
		>
		<div
		...
		<div
			class="code-format-style hiddenScroll h-[20rem] divide-y overflow-auto bg-[#011627]"
		>
			{#if hint === "markdown"}

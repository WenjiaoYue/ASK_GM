...
<div class="flex flex-col flex-wrap sm:flex-row">
	<div class="relative mx-auto mb-12 max-w-screen-xl">
		<div
			class="pricing-box mx-auto max-w-lg overflow-hidden rounded-lg shadow lg:flex lg:max-w-none"
		>
			<div class="lg:flex-shrink-1 bg-white px-6 py-8 lg:p-12">
				...
				<p class="mt-6 text-base leading-6 text-gray-500 ">
					Pose your questions, and we will provide answers. Once a month, let's
					work together to build a better Intel home.
				</p>
				<div class="mt-8">
